//matrice tri_inf * matice tri_sup

#include<stdio.h>  
#include<time.h> 
#include<stdlib.h>  

/* produit de matrice inferieur avec matrice superieur */
...
void produit_mat_tri_inf_avec_mat_tri_sup(int **mat1 ,int **mat2,unsigned n){
    int **res ;
    unsigned i;
    unsigned j;
    unsigned k;
...
int main(){
    ...
    printf("\n\n-------------------------reasultat-------------------------\n\n");
    produit_mat_tri_inf_avec_mat_tri_sup(mat1,mat2,n);
    return 0 ;
}