...
void remplir_mat_ban_sup(int **mat,unsigned n,unsigned m){
    unsigned i;
    unsigned j;
    assert(n>m);
    for(i=0 ; i<n;i++){
...
void produit_mat_ban_sup_vect(int **mat,int *tab,unsigned n,unsigned m){
    unsigned i;
    unsigned j;
    int x;
    assert(n>m);
...
int main(){
    ...
    printf(" \n\n");
    printf("\n\n                  votre res                  \n\n");
    produit_mat_ban_sup_vect(mat,tab,n,m);
    printf(" \n\n");
