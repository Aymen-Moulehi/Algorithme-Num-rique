...
/* produit de matrice inferieur avec matrice inferieur */
...
void produit_mat_tri_inf_avec_mat_tri_inf(int **mat1,int **mat2,unsigned n){
    int **res ;
    unsigned i;
    unsigned j;
    unsigned k;
...
int main(){
    ...
    remplir_mat_tri_inf(mat2,n);
    printf("\n\n-------------------------matrice2-------------------------\n\n");
    affiche_matrice(mat2,n);
    printf("\n\n-------------------------reasultat-------------------------\n\n");
    produit_mat_tri_inf_avec_mat_tri_inf(mat1,mat2,n);
